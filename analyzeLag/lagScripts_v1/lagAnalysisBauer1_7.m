...
m1fc1 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-1-week0-fc1.mat');
m1fc2 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-1-week0-fc2.mat');
m1fc3 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-1-week0-fc3.mat');

m2fc1 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-2-week0-fc1.mat');
m2fc2 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-2-week0-fc2.mat');
m2fc3 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-2-week0-fc3.mat');

m4fc1 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-4-week0-fc1.mat');
m4fc2 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-4-week0-fc2.mat');
m4fc3 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-4-week0-fc3.mat');

m6fc1 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-6-week0-fc1.mat');
m6fc2 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-6-week0-fc2.mat');
m6fc3 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-6-week0-fc3.mat');

m7fc1 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-7-week0-fc1.mat');
m7fc2 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-7-week0-fc2.mat');
m7fc3 = load('D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-7-week0-fc3.mat');
...
sgtitle('Average across 5 mice with 3 runs each, reprocessed');

% change name as needed
saveLagFig = 'D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFig-181116-avg5Mice-dotLagMaskLine-narrow';
