...
for i = 1:length(ds)
    for ind=1:4
        dsCurr = char(ds(i));
        dataLoc = ['D:\ProcessedData\AsherLag\finalDotLagSave30s\young\dotLagTrial30sCat-181116-'...
...
sgtitle('5 mouse avg 30s dotLag, Asher');
subplot(2,1,1);
...
saveLagFig = 'D:\ProcessedData\AsherLag\finalDotLagSave30s\avgFigs\dotLag5AvgFig';
