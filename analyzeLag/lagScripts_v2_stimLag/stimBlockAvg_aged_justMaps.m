function stimBlockAvg_aged_justMaps(dsInput, dateDSInput, useGSR)    
%% input parameters
...
asherData1 = load(['E:\Data_for_Kenny\Aged_Animals\Aged_Week_0\' dateDS '\Processed' dateDS '\' dateDS '-' ds '-week0-dataGCaMP-stim1.mat']);
asherData2 = load(['E:\Data_for_Kenny\Aged_Animals\Aged_Week_0\' dateDS '\Processed' dateDS '\' dateDS '-' ds '-week0-dataGCaMP-stim2.mat']);
asherData3 = load(['E:\Data_for_Kenny\Aged_Animals\Aged_Week_0\' dateDS '\Processed' dateDS '\' dateDS '-' ds '-week0-dataGCaMP-stim3.mat']);

data4Loc = ['E:\Data_for_Kenny\Aged_Animals\Aged_Week_0\' dateDS '\Processed' dateDS '\' dateDS '-' ds '-week0-dataGCaMP-stim4.mat'];
