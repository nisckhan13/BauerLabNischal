 function dotLag_young_30s(dsInput, dateDSInput, useGSR)   
    %% input parameters
    ...
    for ind=1:length(asherData)
        ...
        dotLagFile = ['D:\ProcessedData\AsherLag\finalDotLagSave30s\young\dotLagTrial30sCat-'...
        ...
        saveLagCurrFig = ['D:\ProcessedData\AsherLag\finalDotLagSave30s\young\dotLagTrialAvgFig-'...
    ...
    saveLagFig = ['D:\ProcessedData\AsherLag\finalDotLagSave30s\young\dotLagMouseAvgFig-' dateDS '-'...
        num2str(ds) '-week0'];
