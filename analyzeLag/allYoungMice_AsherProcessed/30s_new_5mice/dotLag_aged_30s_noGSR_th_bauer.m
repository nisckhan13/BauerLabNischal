 function dotLag_aged_30s_noGSR_th_bauer(dsInput, dateDSInput, useGSR, corrThresh)   
    %% input parameters
    ...
    for ind=1:length(bauerDataF)
        ...
        dotLagFile = ['D:\ProcessedData\AsherLag\dotLag30sNewBauer\aged\dotLagTrial30sCat-'...
        ...
        saveLagCurrFig = ['D:\ProcessedData\AsherLag\dotLag30sNewBauer\aged\dotLagTrialAvgFig-'...
    ...
    saveLagFig = ['D:\ProcessedData\AsherLag\dotLag30sNewBauer\aged\dotLagMouseAvgFig-' dateDS '-'...
        num2str(ds) '-week0'];
