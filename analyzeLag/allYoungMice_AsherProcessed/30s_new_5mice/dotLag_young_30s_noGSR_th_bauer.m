 function dotLag_young_30s_noGSR_th_bauer(dsInput, dateDSInput, useGSR, corrThresh)   
    %% input parameters
    ...
    for ind=1:length(bauerDataF)
        ...
        dotLagFile = ['D:\ProcessedData\AsherLag\dotLag30sNewBauer\young\dotLagTrial30sCat-'...
        ...
        saveLagCurrFig = ['D:\ProcessedData\AsherLag\dotLag30sNewBauer\young\dotLagTrialAvgFig-'...
    ...
    saveLagFig = ['D:\ProcessedData\AsherLag\dotLag30sNewBauer\young\dotLagMouseAvgFig-' dateDS '-'...
        num2str(ds) '-week0'];
