...
for i = 1:length(ds)
    for ind=1:4
        dsCurr = char(ds(i));
        dataLoc = ['D:\ProcessedData\AsherLag\dotLag30sNewAsher\aged\dotLagTrial30sCat-180918-'...
...
sgtitle('5 mouse avg 30s dotLag, Aged, Asher');
subplot(2,1,1);
...
saveLagFig = 'D:\ProcessedData\AsherLag\dotLag30sNewAsher\avgFigs\dotLag5AvgFig-aged_1';
