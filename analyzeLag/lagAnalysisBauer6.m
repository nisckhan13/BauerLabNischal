...
disp('load');
tic;
dataFluor1 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc1-dataFluor.mat');
dataHb1 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc1-dataHb.mat');
dataFluor2 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc2-dataFluor.mat');
dataHb2 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc2-dataHb.mat');
dataFluor3 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc3-dataFluor.mat');
dataHb3 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc3-dataHb.mat');
dataFluor4 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc4-dataFluor.mat');
dataHb4 = load('D:\ProcessedData\AsherLag\BauerScripts\181116\181116-6-week0-fc4-dataHb.mat');
toc;
...
for ind=1:4
    dotLagFile = ['D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFile-181116-6-week0-fc' num2str(ind) '.mat'];
...
sgtitle('181116-6-week0');

saveLagFig = 'D:\ProcessedData\AsherLag\TestLagSaveBauer\TestLagFig-181116-6-week0-dotLag';
