...
for i = 1:length(ds)
    for ind=1:4
        dsCurr = char(ds(i));
        dataLoc = ['E:\ProcessedData\HillmanLag\young\dotLagTrial30sCat-181116-'...
...
sgtitle('5 mouse avg 30s dotLag, Young, Hillman');
subplot(2,1,1);
...
saveLagFig = ['E:\ProcessedData\HillmanLag\avgFigs\dotLag5AvgFig-young-hill_' num2str(rLim(2))];
