 function dotLag_aged_30s_noGSR_th_hill(dsInput, dateDSInput, useGSR, corrThresh)   
    %% input parameters
    ...
    for ind=1:length(bauerDataF)
        ...
        dotLagFile = ['E:\ProcessedData\HillmanLag\aged\dotLagTrial30sCat-'...
        ...
        saveLagCurrFig = ['E:\ProcessedData\HillmanLag\aged\dotLagTrialAvgFig-'...
    ...
    saveLagFig = ['E:\ProcessedData\HillmanLag\aged\dotLagMouseAvgFig-' dateDS '-'...
        num2str(ds) '-week0'];
