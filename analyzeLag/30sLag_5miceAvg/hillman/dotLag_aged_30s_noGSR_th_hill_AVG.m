...
for i = 1:length(ds)
    for ind=1:4
        dsCurr = char(ds(i));
        dataLoc = ['E:\ProcessedData\HillmanLag\aged\dotLagTrial30sCat-180918-'...
...
sgtitle('5 mouse avg 30s dotLag, Aged, Hillman');
subplot(2,1,1);
...
saveLagFig = ['E:\ProcessedData\HillmanLag\avgFigs\dotLag5AvgFig-aged-hill_' num2str(rLim(2))];
