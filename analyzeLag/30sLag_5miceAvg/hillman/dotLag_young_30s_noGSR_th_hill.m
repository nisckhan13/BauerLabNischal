 function dotLag_young_30s_noGSR_th_hill(dsInput, dateDSInput, useGSR, corrThresh)   
    %% input parameters
    ...
    maskData = load(['E:\ProcessedData\HillmanLag\'...
        dateDS '\' dateDS '-' ds '-week0-LandmarksAndMask.mat']);
    bauerData1F = load(['E:\ProcessedData\HillmanLag\'...
        dateDS '\' dateDS '-' ds '-week0-fc1-dataFluor.mat']);
    bauerData1H = load(['E:\ProcessedData\HillmanLag\'...
        dateDS '\' dateDS '-' ds '-week0-fc1-dataHb.mat']);
    bauerData2F = load(['E:\ProcessedData\HillmanLag\'...
        dateDS '\' dateDS '-' ds '-week0-fc2-dataFluor.mat']);
    bauerData2H = load(['E:\ProcessedData\HillmanLag\'...
        dateDS '\' dateDS '-' ds '-week0-fc2-dataHb.mat']);
    bauerData3F = load(['E:\ProcessedData\HillmanLag\'...
        dateDS '\' dateDS '-' ds '-week0-fc3-dataFluor.mat']);
    bauerData3H = load(['E:\ProcessedData\HillmanLag\'...
        dateDS '\' dateDS '-' ds '-week0-fc3-dataHb.mat']);

    data4LocF = ['E:\ProcessedData\HillmanLag\' dateDS '\'...
        dateDS '-' ds '-week0-fc4-dataFluor.mat'];
    data4LocH = ['E:\ProcessedData\HillmanLag\' dateDS '\'...
    ...
    for ind=1:length(bauerDataF)
        ...
        dotLagFile = ['E:\ProcessedData\HillmanLag\young\dotLagTrial30sCat-'...
        ...
        saveLagCurrFig = ['E:\ProcessedData\HillmanLag\young\dotLagTrialAvgFig-'...
    ...
    saveLagFig = ['E:\ProcessedData\HillmanLag\young\dotLagMouseAvgFig-' dateDS '-'...
        num2str(ds) '-week0'];
