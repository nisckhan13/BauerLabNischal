...
for i = 1:length(ds)
    for ind=1:4
        dsCurr = char(ds(i));
        dataLoc = ['D:\ProcessedData\AsherLag\dotLag30sNewAsher\young\dotLagTrial30sCat-181116-'...
...
sgtitle('5 mouse avg 30s dotLag, Young, Asher');
subplot(2,1,1);
...
saveLagFig = 'D:\ProcessedData\AsherLag\dotLag30sNewAsher\avgFigs\dotLag5AvgFig-young_1';
