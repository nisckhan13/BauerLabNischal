 function dotLag_young_30s_noGSR_th(dsInput, dateDSInput, useGSR, corrThresh)   
    %% input parameters
    ...
    maskData = load(['E:\Data_for_Kenny\Young_Animals\Young_Week_0\' dateDS...
        '\Processed' dateDS '\' dateDS '-' ds '-week0-LandmarksandMask.mat']);
    asherData1 = load(['E:\Data_for_Kenny\Young_Animals\Young_Week_0\' dateDS...
        '\Processed' dateDS '\' dateDS '-' ds '-week0-dataGCaMP-fc1.mat']);
    asherData2 = load(['E:\Data_for_Kenny\Young_Animals\Young_Week_0\' dateDS...
        '\Processed' dateDS '\' dateDS '-' ds '-week0-dataGCaMP-fc2.mat']);
    asherData3 = load(['E:\Data_for_Kenny\Young_Animals\Young_Week_0\' dateDS...
        '\Processed' dateDS '\' dateDS '-' ds '-week0-dataGCaMP-fc3.mat']);

    data4Loc = ['E:\Data_for_Kenny\Young_Animals\Young_Week_0\' dateDS...
    ...
    for ind=1:length(asherData)
        ...
        dotLagFile = ['D:\ProcessedData\AsherLag\dotLag30sNewAsher\young\dotLagTrial30sCat-'...
        ...
        saveLagCurrFig = ['D:\ProcessedData\AsherLag\dotLag30sNewAsher\young\dotLagTrialAvgFig-'...
    ...
    saveLagFig = ['D:\ProcessedData\AsherLag\dotLag30sNewAsher\young\dotLagMouseAvgFig-' dateDS '-'...
        num2str(ds) '-week0'];
