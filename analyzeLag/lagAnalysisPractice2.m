...
disp('load');
tic;
maskData = load('C:\Users\Nischal\Documents\TestData\181116\181116-2-week0-LandmarksandMask.mat');
asherData1 = load('C:\Users\Nischal\Documents\TestData\181116\181116-2-week0-dataGCaMP-fc1.mat');
asherData2 = load('C:\Users\Nischal\Documents\TestData\181116\181116-2-week0-dataGCaMP-fc2.mat');
asherData3 = load('C:\Users\Nischal\Documents\TestData\181116\181116-2-week0-dataGCaMP-fc3.mat');
toc;
...
for ind=1:3
    dotLagFile = ['D:\ProcessedData\AsherLag\TestLagSave\TestLagFile-181116-2-week0-fc' num2str(ind) '.mat'];
...
saveLagFig = 'D:\ProcessedData\AsherLag\TestLagSave\TestLagFig-181116-2-week0-dotLag';
