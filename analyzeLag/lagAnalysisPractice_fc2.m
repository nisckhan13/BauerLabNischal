...
%% analyze data
xform_datadeoxy = asherData3.deoxy;
xform_dataoxy = asherData3.oxy;
xform_datafluorCorr = asherData3.gcamp6corr;
...
sgtitle('181116-1-week0-DotLag-[0.04-2Hz] fc3');
...
%% P2
tNull = lagTime(16,41); % if positive, hb lags behind gcamp
aNull = lagAmp(27,43);
